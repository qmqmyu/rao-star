...
class LispIterator(object):
    ...
    def next(self):
        ...
        try:
            # python3 iterators call __next__(), but python2 calls next()
            return self.__next__()
        except StopIteration:
            # no idea why old code raised a condition if you got to the end... seems really strange
            raise StopIteration#self._raise_if(True, "already at end")
